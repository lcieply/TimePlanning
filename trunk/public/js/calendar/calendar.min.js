...
!function (a) {
    ...
    var Pa = a.fullCalendar = {version: "2.5.0", internalApiVersion: 1}, Qa = Pa.views = {};
    ...
    var eb = Pa.Emitter = ra.extend({
        ...
        getDayClasses: function (a) {
            var b = this.view, c = b.calendar.getNow().stripTime(), d = ["fc-" + Ta[a.day()]];
    ...
    kb.mixin({
        ...
        listenToExternalDrag: function (a, b, c) {
            var d, e = this, f = Ba(a), i = new ib(this, {
        ...
        eventsToSegs: function (b, c) {
            ...
            return a.each(e, function (a, b) {
                ...
                if (xa(b[0]))for (g = d.invertRanges(g), e = 0; e < g.length; e++)d.generateEventSegs(g[e], b[0], c, f); else for (e = 0; e < g.length; e++)d.generateEventSegs(g[e], b[e], c, f)
            }), f
        },
        eventToRange: function (a) {
            return {start: a.start.clone().stripZone(), end: this.view.calendar.getEventEnd(a).stripZone()}
        },
    ...
    var nb = Pa.TimeGrid = kb.extend(lb, {
        ...
        renderFill: function (b, c, d) {
            var e, f, g, h, i, j, k, l, m, n;
            if (c.length) {
                for (c = this.renderFillSegEls(b, c), e = this.groupSegCols(c), d = d || b.toLowerCase(), f = a('<div class="fc-' + d + '-skeleton"><table><tr/></table></div>'), g = f.find("tr"), h = 0; h < e.length; h++)if (i = e[h], j = a("<td/>").appendTo(g), i.length)for (k = a('<div class="fc-' + d + '-container"/>').appendTo(j), l = this.getCellDate(0, h), m = 0; m < i.length; m++)n = i[m], k.append(n.el.css({
